...
void solve() {
    /*
    S, K, S, K...
    S wins if a is non-decreasing

    K can only make a change if he gets the last turn and if
    there are distinct elements

    1 1 1 5 5
    If the last turn is filled with the same number, it doesn't matter
    */
    int n; cin >> n;
    vector<int> a(n);
