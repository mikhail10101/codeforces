...
void solve() {
    int n, m; cin >> n >> m;
    /*
    In an MxN grid, maximize the sum of MEX accross all rows and cols

    One row should have 0 to n
    This leaves all other rows with an mex of 0
    One col will have an mex of 1 and the rest 0
