...
void solve() {
    ...
    n--;
    /*
    Terms appear at (2k - 2)t + x or (2k - 2)t + 2k - x
    Find how many options satisfy (2k - 2)t + x = n
        (2k - 2)t = (n - x)
    Find how many options satisfy (2k - 2)t + 2k - x = n
        (2k - 2)t = (n + x - 2k) = (n + x - 2) + (-2k + 2)
        (2k - 2)(t - 1) = (n + x - 2)
    True except for all x = 1 and x = k
    */
}
