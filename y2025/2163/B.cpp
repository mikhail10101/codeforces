...
void solve() {
    ...
    Choose l and r
    For every i between l and r that sits between the bounds of a[l]
    and a[r], set them to 1

    Divide the input string into 5 segments at most that can be run
    through the operation

    If xi = 0, si can have any value

    What does the worst case scenario look like?
    n-3 3 n-1 1 n 2 n-2 4
    */
}
